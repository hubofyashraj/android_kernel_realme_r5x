...
#ifdef CONFIG_PELT_UTIL_HALFLIFE_2
static const u32 runnable_avg_yN_inv[] __maybe_unused = {
...
#define LOAD_AVG_PERIOD 2
#define LOAD_AVG_MAX 3493
#define LOAD_AVG_MAX_N 20

#endif

#ifdef CONFIG_PELT_UTIL_HALFLIFE_1
static const u32 runnable_avg_yN_inv[] __maybe_unused = {
	0xffffffff,
};
...
#define LOAD_AVG_PERIOD 1
#define LOAD_AVG_MAX 2046
#define LOAD_AVG_MAX_N 9
