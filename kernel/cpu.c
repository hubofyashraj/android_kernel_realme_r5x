...
#if CONFIG_LITTLE_CPU_FIRST_MASK
static const unsigned long lp_cpu_first_bits = CONFIG_LITTLE_CPU_FIRST_MASK;
const struct cpumask *const cpu_lp_first_mask = to_cpumask(&lp_cpu_first_bits);
#else
const struct cpumask *const cpu_lp_first_mask = cpu_possible_mask;
#endif
EXPORT_SYMBOL(cpu_lp_first_mask);

#if CONFIG_LITTLE_CPU_SECOND_MASK
static const unsigned long lp_cpu_second_bits = CONFIG_LITTLE_CPU_SECOND_MASK;
const struct cpumask *const cpu_lp_second_mask = to_cpumask(&lp_cpu_second_bits);
#else
const struct cpumask *const cpu_lp_second_mask = cpu_possible_mask;
#endif
EXPORT_SYMBOL(cpu_lp_second_mask);

#if CONFIG_LITTLE_CPU_THIRD_MASK
static const unsigned long lp_cpu_third_bits = CONFIG_LITTLE_CPU_THIRD_MASK;
const struct cpumask *const cpu_lp_third_mask = to_cpumask(&lp_cpu_third_bits);
#else
const struct cpumask *const cpu_lp_third_mask = cpu_possible_mask;
#endif
EXPORT_SYMBOL(cpu_lp_third_mask);

#if CONFIG_LITTLE_CPU_FOURTH_MASK
static const unsigned long lp_cpu_fourth_bits = CONFIG_LITTLE_CPU_FOURTH_MASK;
const struct cpumask *const cpu_lp_fourth_mask = to_cpumask(&lp_cpu_fourth_bits);
#else
const struct cpumask *const cpu_lp_fourth_mask = cpu_possible_mask;
#endif
EXPORT_SYMBOL(cpu_lp_fourth_mask);
...
#if CONFIG_BIG_CPU_FOURTH_MASK
static const unsigned long perf_cpu_fourth_bits = CONFIG_BIG_CPU_FOURTH_MASK;
const struct cpumask *const cpu_perf_fourth_mask = to_cpumask(&perf_cpu_fourth_bits);
#else
const struct cpumask *const cpu_perf_fourth_mask = cpu_possible_mask;
#endif
EXPORT_SYMBOL(cpu_perf_fourth_mask);
