...
static unsigned long lru_gen_min_ttl __read_mostly = CONFIG_LRU_GEN_MIN_TTL * HZ;
...
int kswapd_run(int nid)
{
	...
	pgdat->kswapd = kthread_run_perf_critical(cpu_perf_first_mask, kswapd, pgdat, "kswapd%d", nid);
